                            ...
                            <div id="logo" class="logo">
                                <a href="index.php" rel="home">
                                  ...
                                  foreach ($logo->result_array() as $row) {
                                    echo "<a href='".base_url()."'><img  style='width:70% ! important;' src='".base_url()."asset/logo/mbaturi_black.png'/></a>";
                                  }
                                  ?>
                                </a>
                            </div><!-- /.logo -->
                            ...
                            <div class="wrap-widget-header clearfix">
                                <aside class="widget widget-info">
                                    <div class="textwidget clearfix">
                                        ...
                                        <div class="info-text">
                                       <h6>
                                       	<a href="https://api.whatsapp.com/send?phone=<?php echo"+$iden[no_telp]"; ?>&text=Hi%20there%21"><?php echo"+$iden[no_telp] (Abi)<br>"; ?></a>
                                       	<a href="https://api.whatsapp.com/send?phone=+6281953554143&text=Hi%20there%21">+6281953554143 (Wiwit)</a></h6>
                                ...
                                <aside class="widget widget-info">
                                      <div class="textwidget clearfix">
                                          ...
                                          <div class="info-text">
                                              <p style="color:black;"><?php echo"$iden[alamat]"; ?></p>
                                          </div>
                                      </div>
                                  </aside>
                                <br><br>
                ...
                <div class="col-lg-3 col-sm-6 reponsive-mb30">
                    <div class="widget-logo">
                        ...
                        <ul class="flat-information">
                            ...
                            <li><i class="fa fa-phone"></i><a href="https://api.whatsapp.com/send?phone=<?php echo"+$iden[no_telp]"; ?>&text=Hi%20there%21"><?php echo"+$iden[no_telp] (Abi) <br>"; ?></a></li>
                            <li><i class="fa fa-mobile"></i><a href="https://api.whatsapp.com/send?phone=+6281953554143&text=Hi%20there%21">+6281953554143 (Wiwit)</a></li> 
                            <!-- <li><i class="fa fa-mobile"></i><a href="https://api.whatsapp.com/send?phone=+6281214071941&text=Hi%20there%21">+6281214071941 (Arep)</a></li> -->
                            <li><i class="fa fa-envelope"></i><a href="mailto:<?php echo"$iden[email]"; ?>"><?php echo"$iden[email]"; ?></a></li>
                        </ul>
                    </div>
                </div><!-- /.col-md-3 -->
