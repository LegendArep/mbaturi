...
echo '<!-- Client Name -->
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                <select name="id_client_ind" class="chosen-select form-control" id="scripts" data-placeholder="Choose a Client...">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <span class="input-icon">
                    ...
                    <input name="cert_date" class="form-control date-picker input-icon input-icon-right" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" placeholder="Certified Date"
                ...
                <span class="input-icon control-label">
                ...
                <span class="input-icon">
                    ...
                    <input name="exp_date" class="form-control date-picker input-icon input-icon-right" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" placeholder="Expiration Date" value="' . $tahun_jumlah . '-' . $bulan . '-' . $hari_kurang . '  "/>
...
<script src="assets/ajax/libs/jquery1.10.2/jquery.min.js"></script>
