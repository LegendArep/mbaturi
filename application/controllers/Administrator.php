...
class Administrator extends CI_Controller {
    ...
    function daftaremail(){
        cek_session_akses('daftaremail',$this->session->id_session);
            $data['record'] = $this->model_app->view_ordering('email','id_email','DESC');
        $this->template->load('administrator/template','administrator/mod_daftaremail/daftaremail',$data);
    }

        function delete_email(){
        cek_session_akses('email',$this->session->id_session);
            $id = array('id_email' => $this->uri->segment(3));
        $this->model_app->delete('email',$id);
        redirect($this->uri->segment(1).'/daftaremail');
    }
    ...
    function header(){
        cek_session_akses('header',$this->session->id_session);
            $data['record'] = $this->model_app->view_ordering('header','id_header','DESC');
        $this->template->load('administrator/template','administrator/mod_header/view_header',$data);
    }
   ...
   function tambah_header(){
        cek_session_akses('header',$this->session->id_session);
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/header/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
            $config['max_size'] = '3000'; // kb
            $this->load->library('upload', $config);
            ...
            $hasil=$this->upload->data();
            if ($hasil['file_name']==''){
                    $data = array('heading'=>$this->db->escape_str($this->input->post('a')),
                                    'subheading'=>$this->input->post('b'),
                                    'keterangan'=>$this->input->post('c'),
                                    'button1'=>$this->input->post('d'),
                                    'url_button1'=>$this->input->post('e'),
                                    'buton2'=>$this->input->post('f'),
                                    'url_button2'=>$this->input->post('g')
  );
            }else{
                    $data = array('heading'=>$this->db->escape_str($this->input->post('a')),
                                    'subheading'=>$this->input->post('b'),
            ...
            $this->model_app->insert('header',$data);
            redirect($this->uri->segment(1).'/header');
        }else{
            $this->template->load('administrator/template','administrator/mod_header/view_header_tambah');
        }
    }
    ...
    function edit_header(){
        ...
        if (isset($_POST['submit'])){
            ...
            $where = array('id_header' => $this->input->post('id'));
            $this->model_app->update('header', $data, $where) or die (mysql_error());
            redirect($this->uri->segment(1).'/header');
        }else{

                 $proses = $this->model_app->edit('header', array('id_header' => $id))->row_array();

            $data = array('rows' => $proses);
            $this->template->load('administrator/template','administrator/mod_header/view_header_edit',$data);
        }
    }



    function delete_listheader(){
        cek_session_akses('header',$this->session->id_session);
            $id = array('id_header' => $this->uri->segment(3));
        $this->model_app->delete('header',$id);
        redirect($this->uri->segment(1).'/header');
    }
    ...
    function project(){
        ...
        $this->template->load('administrator/template','administrator/mod_project/project',$data);
    }


    function staff(){
        cek_session_akses('staff',$this->session->id_session);
            $data['record'] = $this->model_app->view_ordering('staff','id_staff','DESC');
        $this->template->load('administrator/template','administrator/mod_staff/staff',$data);
    }
    ...
    function detail_project(){
        cek_session_akses('project',$this->session->id_session);
        $id = $this->uri->segment(3);
        $baru =$this->input->post('id');
                if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/sub_project/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
            $config['max_size'] = '3000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('k');
            ...
            $this->model_app->insert('image_project',$data);
            redirect($this->uri->segment(1).'/detail_project/'.$baru);
                } else {
        $data['record'] = $this->model_utama->view_where('image_project', array('id_project' => $id))->row_array();
        $this->template->load('administrator/template','administrator/mod_project/detail',$data);
    }
}
   ...
   function tambah_project(){
        cek_session_akses('project',$this->session->id_session);
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/project/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
            $config['max_size'] = '3000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('k');
            ...
            if ($hasil['file_name']==''){
                    $data = array('judul'=>$this->db->escape_str($this->input->post('a')),
                                    'sub_judul'=>$this->input->post('b'),
                                    'isi'=>$this->input->post('c'),
            ...
            $this->template->load('administrator/template','administrator/mod_project/tambah');
        }
    }
   ...
   function tambah_staff(){
        cek_session_akses('staff',$this->session->id_session);
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/foto_staf/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
            $config['max_size'] = '3000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('k');
            ...
            if ($hasil['file_name']==''){
                    $data = array('nama'=>$this->db->escape_str($this->input->post('a')),
                                    'jabatan'=>$this->input->post('b'),
                                    'facebook'=>$this->input->post('c'),
                                    'twitter'=>$this->input->post('d'),
                                    'google'=>$this->input->post('e'),
                                    'linkedin'=>$this->input->post('f'));
            ...
            $this->model_app->insert('staff',$data);
            redirect($this->uri->segment(1).'/staff');
        }else{
            $this->template->load('administrator/template','administrator/mod_staff/tambah');
        }
    }
    ...
    function edit_staff(){
        ...
        if (isset($_POST['submit'])){
            ...
            $where = array('id_staff' => $this->input->post('id'));
            $this->model_app->update('staff', $data, $where) or die (mysql_error());
            redirect($this->uri->segment(1).'/staff');
        }else{
            $proses = $this->model_app->edit('staff', array('id_staff' => $id))->row_array();
            $data = array('rows' => $proses);
            $this->template->load('administrator/template','administrator/mod_staff/edit',$data);
        }
    }
    ...
    function edit_project(){
        ...
        if (isset($_POST['submit'])){
            ...
            $this->model_app->update('project', $data, $where) or die (mysql_error());
            redirect($this->uri->segment(1).'/project');
        }else{
            $proses = $this->model_app->edit('project', array('id_project' => $id))->row_array();
            $data = array('rows' => $proses);
            $this->template->load('administrator/template','administrator/mod_project/edit',$data);
        }
    }
    ...
    function delete_staff(){
        cek_session_akses('staff',$this->session->id_session);
            $id = array('id_staff' => $this->uri->segment(3));
        $this->model_app->delete('staff',$id);
        redirect($this->uri->segment(1).'/staff');
    }


    function delete_projectt(){
        cek_session_akses('project',$this->session->id_session);
            $id = array('id_image' => $this->uri->segment(3));
        $this->model_app->delete('image_project',$id);
        redirect($this->uri->segment(1).'/detail_project/'.$this->uri->segment(4));
    }
...
//************************************************************************************************//
    ...
    function service(){
        cek_session_akses('serivce',$this->session->id_session);
            $data['record'] = $this->model_app->view_ordering('service','id_service','DESC');
        $this->template->load('administrator/template','administrator/mod_service/service',$data);
    }



   function tambah_service(){
        cek_session_akses('service',$this->session->id_session);
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/service/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
            $config['max_size'] = '3000'; // kb
            $this->load->library('upload', $config);
            $this->upload->do_upload('k');
            ...
            $this->model_app->insert('service',$data);
            redirect($this->uri->segment(1).'/service');
        }else{
            $this->template->load('administrator/template','administrator/mod_service/tambah');
        }
    }
    ...
    function edit_service(){
        ...
        if (isset($_POST['submit'])){
            ...
            $where = array('id_service' => $this->input->post('id'));
            $this->model_app->update('service', $data, $where) or die (mysql_error());
            redirect($this->uri->segment(1).'/service');
        }else{
            $proses = $this->model_app->edit('service', array('id_service' => $id))->row_array();
            $data = array('rows' => $proses);
            $this->template->load('administrator/template','administrator/mod_service/edit',$data);
        }
    }
    ...
    function delete_service(){
        cek_session_akses('service',$this->session->id_session);
            $id = array('id_service' => $this->uri->segment(3));
        $this->model_app->delete('service',$id);
        redirect($this->uri->segment(1).'/service');
    }
...
//********************************************************************//
    ...
    function tambah_listberita(){
        ...
        if (isset($_POST['submit'])){
            ...
            //////////////////////////////////////////// taruh sini
                ...
                $urlaaa           = seo_title($this->input->post('b'));
                ...
                $message      = "<html>
                                    ...
                                    <table style='margin-left:25px'>
                                        <tr><td>Hallo,<br>
                                        Informasi Terbaru Dari Kami  <span style='color:red'>$iden[url]</span>.<br>
                                        Klik link di bawah ini <br/>
                                        $iden[url]/$urlaaa </td></tr>
                                    </table>
                                </body></html> \n";


                $ksm = $this->db->query("select * from email");
                foreach ($ksm->result_array() as $row){
                $this->email->from($iden['email'], $iden['nama_website']);
    ...
    function homepage(){
    cek_session_akses('homepage',$this->session->id_session);
        if (isset($_POST['submit'])){

                $data = array('layar1_headline'=>$this->input->post('a'),
                                'layar1_keterangan'=>$this->input->post('b'),
                                'layar2_headline'=>$this->input->post('c'),
                                'layar2_keterangan'=>$this->input->post('d'),
                                'layar3_keterangan'=>$this->input->post('e'),
                                'layar4_keterangan'=>$this->input->post('f'),
                                'header_judul'=>$this->input->post('g'),
                                'header_url'=>$this->input->post('h'));

            $where = array('id_homepage' => $this->input->post('id'));
            $this->model_app->update('homepage', $data, $where);

            redirect($this->uri->segment(1).'/homepage');
        }else{
            $proses = $this->model_app->edit('homepage', array('id_homepage' => 1))->row_array();
            $data = array('record' => $proses);
            $this->template->load('administrator/template','administrator/mod_homepage/homepage',$data);
        }
    ...
    function klien(){
        ...
        if ($this->session->level=='admin'){
            $data['record'] = $this->model_app->view_ordering('klien_list','id_client_ind','DESC');
        }else{
            $data['record'] = $this->model_app->view_where_ordering('klien_list',array('username'=>$this->session->username),'id_client_ind','DESC');
        }
        $this->template->load('administrator/template','administrator/mod_klien/view_klien',$data);
    }
    ...
    function tambah_klien(){
        ...
        if (isset($_POST['submit'])){
            ...
            $this->template->load('administrator/template','administrator/mod_klien/view_klien_tambah');
        }    
    }
    ...
    function edit_klien(){
        ...
        if (isset($_POST['submit'])){
            ...
            $data = array('rows' => $proses);
            $this->template->load('administrator/template','administrator/mod_klien/view_klien_edit',$data);
        }
    }

    function delete_klien(){
        cek_session_akses('klien',$this->session->id_session);
        if ($this->session->level=='admin'){
            $id = array('id_client_ind' => $this->uri->segment(3));
        }else{
            $id = array('id_client_ind' => $this->uri->segment(3), 'username'=>$this->session->username);
        }
        $this->model_app->delete('klien_list',$id);
        redirect($this->uri->segment(1).'/klien');
    }
    ...
    function sertifikat(){
        ...
        if ($this->session->level=='admin'){
            ...
            $data['record'] = $this->model_app->view_where_ordering('v_get_daftar_sertifikat',array('username'=>$this->session->username),'id_client_ind','DESC');
        }
    ...
    function tambah_testimoni(){
        cek_session_akses('testimoni',$this->session->id_session);
        if (isset($_POST['submit'])){
            $config['upload_path'] = 'asset/foto_orang/';
            $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
            ...
            $hasil=$this->upload->data();
            if ($hasil['file_name']==''){
                $data = array('nama_kosumen'=>$this->input->post('a'),
                    'jabatan'=>$this->input->post('b'),
                    'isi_testimoni'=>$this->input->post('c'),
                              'waktu_testimoni'=>date('Y-m-d'),
                              'aktif'=>'Y');
            }else{
                $data = array('nama_kosumen'=>$this->input->post('a'),
                    'jabatan'=>$this->input->post('b'),
    ...
    function detail_pesanmasuk(){
        ...
        if (isset($_POST['submit'])){
            ...
            $this->email->from('prabowosh@gmail.com', 'themelokomedia');
            $this->email->to($email);
            $this->email->cc('');
            $this->email->bcc('');
