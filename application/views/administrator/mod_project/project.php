                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$row[sub_judul]</td>
                              <td><center>
                                <a class='btn btn-warning btn-xs' title='Tambah Image Project' href='".base_url().$this->uri->segment(1)."/detail_project/$row[id_project]'><span class='glyphicon glyphicon-file'></span></a>
